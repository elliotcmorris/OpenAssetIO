...
class OpenAssetIOConan(ConanFile):
    ...
    def configure(self):
        if self.settings.os == "Windows":
            # Without the following, cpython doesn't get installed with
            # all artifacts on Windows, e.g. `python -m venv` doesn't
            # work. See: https://github.com/conan-io/conan-center-index/issues/9332
            # However, with the following, the bundled Python
