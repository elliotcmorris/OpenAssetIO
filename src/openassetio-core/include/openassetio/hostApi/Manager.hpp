...
class OPENASSETIO_CORE_EXPORT Manager {
 public:
   ...
   *  - For @fqref{Context.Access} "read" contexts, any additional traits with properties that
   *    you wish to resolve for that type of entity.
   *  - For @fqref{Context.Access} "write" contexts, any additional traits with properties that
   ...
   * `kWrite` and the traits of a `ShotSpecification`s, then the Manager
