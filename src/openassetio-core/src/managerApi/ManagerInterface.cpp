 ...
 */
class IdentityEntityReferencePagerInterface : public managerApi::EntityReferencePagerInterface {
...
void ManagerInterface::getWithRelationshipPaged(
  ...
  for (std::size_t idx = 0; idx < size; ++idx) {
    successCallback(idx, std::make_shared<IdentityEntityReferencePagerInterface>());
  }
}
